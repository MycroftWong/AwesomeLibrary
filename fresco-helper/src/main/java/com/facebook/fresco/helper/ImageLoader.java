...
public class ImageLoader {
    ...
    public static void loadImageBlur(final View view, String url) {
        loadImage(view.getContext(), url, source -> {
            IterativeBoxBlurFilter.boxBlurBitmapInPlace(source, 0, 8);
            view.setBackground(new BitmapDrawable(view.getContext().getResources(), source));
...
//            view.setBackground(new BitmapDrawable(view.getContext().getResources(), blurBitmap));
    ...
    public static void loadImageBlur(final View view, String url, final int reqWidth, final int reqHeight) {
        loadImage(view.getContext(), url, reqWidth, reqHeight, source -> {
            IterativeBoxBlurFilter.boxBlurBitmapInPlace(source, 0, 8);
            view.setBackground(new BitmapDrawable(view.getContext().getResources(), source));
...
//            view.setBackground(new BitmapDrawable(view.getContext().getResources(), blurBitmap));
    ...
    public static void loadImageBlur(final SimpleDraweeView draweeView, String url) {
        loadImage(draweeView, url, new BlurPostProcessor(8, draweeView.getContext()));
    }

    public static void loadImageBlur(final SimpleDraweeView draweeView, String url, final int reqWidth, final int reqHeight) {
        loadImage(draweeView, url, reqWidth, reqHeight, new BlurPostProcessor(8, draweeView.getContext()));
    }

    public static void loadFileBlur(final SimpleDraweeView draweeView, String filePath) {
        loadFile(draweeView, filePath, new BlurPostProcessor(8, draweeView.getContext()));
    }

    public static void loadFileBlur(final SimpleDraweeView draweeView, String filePath, final int reqWidth, final int reqHeight) {
        loadFile(draweeView, filePath, reqWidth, reqHeight, new BlurPostProcessor(8, draweeView.getContext()));
    }

    public static void loadDrawableBlur(SimpleDraweeView draweeView, int resId, final int reqWidth, final int reqHeight) {
        loadDrawable(draweeView, resId, reqWidth, reqHeight, new BlurPostProcessor(8, draweeView.getContext()));
    }

    public static void loadDrawableBlur(SimpleDraweeView draweeView, int resId) {
        loadDrawable(draweeView, resId, new BlurPostProcessor(8, draweeView.getContext()));
    }
