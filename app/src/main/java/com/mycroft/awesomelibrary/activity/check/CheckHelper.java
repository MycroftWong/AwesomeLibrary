...
public abstract class CheckHelper {
    ...
    public final void bind(final Object d, final RecyclerView.ViewHolder v, View clickedView) {
        if (clickedView != null) {
            clickedView.setOnClickListener(view -> select(d, v));
        }
    ...
    /**
     * 每次{ Adapter#onBindViewHolder(RecyclerView.ViewHolder, int)}
    ...
    public interface onBindListener<D, V extends RecyclerView.ViewHolder> {
        ...
        /**
         * 每次Adapter#onBindViewHolder(RecyclerView.ViewHolder, int)}方法调用
         * 或者
         * 主动调用{bind(Object, ViewHolder)}及{bind(Object, ViewHolder, boolean)}
         * 时调用
         */
    ...
    public interface OnSelectListener<D, V extends RecyclerView.ViewHolder> {
        ...
        /**
         * 只有点击时或者主动调用
         * {select(Object, ViewHolder, boolean)}
         * or
         * {select(Object, ViewHolder)}
         * 方法时调用
         */
