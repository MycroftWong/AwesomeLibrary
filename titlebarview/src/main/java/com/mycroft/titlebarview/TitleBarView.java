package com.mycroft.titlebarview;
...
import com.mycroft.titlebarview.utils.ScreenHelper;
import com.mycroft.titlebarview.utils.StringHelper;
import com.mycroft.titlebarview.utils.UIDrawableHelper;
import com.mycroft.titlebarview.utils.UIResHelper;
import com.mycroft.titlebarview.utils.UIViewHelper;
import com.mycroft.titlebarview.widget.UIAlphaImageButton;
...
public class TitleBarView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.TitleBarView, defStyleAttr, 0);
        if (array != null) {
            mTitleBarDividerColor = array.getColor(R.styleable.TitleBarView_titlebar_divider_color, ContextCompat.getColor(context, R.color.divider));
            mTitleBarDividerHeight = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_divider_height, 1);
            mTitleBarBgColor = array.getColor(R.styleable.TitleBarView_titlebar_bg_color, Color.WHITE);
            boolean showDivider = array.getBoolean(R.styleable.TitleBarView_titlebar_show_divider, true);
    ...
    private void getCommonFieldFormTypedArray(Context context, TypedArray array) {
        mLeftBackDrawableRes = array.getResourceId(R.styleable.TitleBarView_titlebar_left_back_drawable_id, R.id.titlebar_item_left_back);
        mTitleGravity = array.getInt(R.styleable.TitleBarView_titlebar_title_gravity, Gravity.CENTER);
        mTitleTextSize = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_title_text_size, ScreenHelper.sp2px(context, 17));
        mTitleTextSizeWithSubTitle = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_title_text_size, ScreenHelper.sp2px(context, 16));
        mSubTitleTextSize = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_subtitle_text_size, ScreenHelper.sp2px(context, 11));
        mTitleTextColor = array.getColor(R.styleable.TitleBarView_titlebar_title_color, UIResHelper.getAttrColor(context, R.attr.config_color_gray_1));
        mSubTitleTextColor = array.getColor(R.styleable.TitleBarView_titlebar_subtitle_color, UIResHelper.getAttrColor(context, R.attr.config_color_gray_4));
        mTitleMarginHorWhenNoBtnAside = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_title_margin_horizontal_when_no_btn_aside, 0);
        mTitleContainerPaddingHor = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_title_container_padding_horizontal, 0);
        mTopBarImageBtnWidth = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_image_btn_width, ScreenHelper.dp2px(context, 48));
        mTopBarImageBtnHeight = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_image_btn_height, ScreenHelper.dp2px(context, 48));
        mTopBarTextBtnPaddingHor = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_text_btn_padding_horizontal, ScreenHelper.dp2px(context, 12));
        mTopBarTextBtnTextColor = array.getColorStateList(R.styleable.TitleBarView_titlebar_text_btn_color_state_list);
        mTopBarTextBtnTextSize = array.getDimensionPixelSize(R.styleable.TitleBarView_titlebar_text_btn_text_size, ScreenHelper.sp2px(context, 16));
    }
